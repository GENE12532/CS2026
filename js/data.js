...
const CS2026_DATA = {
  ...
  introductions: [
    ...
    "网络空间安全国际研讨会（International Workshop on Cyber Security）顺应时代发展需求而设立，致力于探讨网络空间安全领域的热点问题、前沿技术与关键理论。自2015年在西安首次举办以来，会议先后在厦门、武汉、北京、广州、南京、天津、杭州等地成功召开，汇聚了国内外众多专家学者，已成为网络空间安全领域具有重要影响力的学术交流平台。2026年会议将在济宁举办，由曲阜师范大学承办，邀请多位业内知名专家作特邀报告，报告内容涵盖网络空间安全、密码学、数据安全、人工智能安全、系统安全等多个方向。诚邀海内外专家学者相聚孔孟之乡，共同交流最新研究成果，携手推动网络空间安全事业高质量发展！",
  ],
  ...
  sponsorBenefits: [
    "在CS 2026网站上公布；",
    "出现在CS 2026的会议程序册上；",
    "出现在会议背景板及大会期间休息时会场屏幕；",
    "根据赞助商需求，在会场外安排宣传桌。",
    "银牌赞助商免费注册一人；金牌赞助免费注册两人；钻石赞助商免费注册三人，并在会议开幕式特别鸣谢；",
  ],
...
这些新方法显著提升了分布式隐私保护技术的实用性，为在分布式环境下实现高效用、安全的数据利用提供了新的解决思路，并为未来的隐私计算与可信人工智能奠定了更加坚实的理论与应用基础。`, 
    ...
    },
    {
      ...
      title: "Secure GPT：GPT模型的隐私保护安全多方推理（题目待定）",
      abstract: `（题目待定）`, 
    ...
    },
    {
      ...
      title: "软件漏洞挖掘智能体技术",
      abstract: `（题目待定）`,
      bio: `求是杰出青年学者奖获得者、MIT TR35 China入选者、中国科协青年人才托举工程入选者`,
    },
  ],
  ...
  registration: {
    ...
    receiptInstruction:
      '将回执单和缴费凭证，以"CS2026+姓名"的形式命名，发送至邮箱：xxx@163.com',
    receiptLink: "file/CS-reply.xlsx",
  },

  /* ==================== Venue ==================== */
  venue: {
    description:
      "CS2026 将在曲阜银座佳悦酒店举行。酒店位于曲阜市核心区域，地址是山东省济宁市曲阜市德化路169号。交通便利，距离济宁大安机场约29.7公里，车程约40分钟；距曲阜东站约9.5公里，乘车行程约为12分钟，距离曲阜不夜城约1公里，至孔府、孔庙2.9公里。",
    hotelName: "银座佳悦",
    address: "山东曲阜德化路169号",
    roomPrice:
      "大床房：xxx 元/间/天/单早      双床房：XXX 元/间/天/双早（协议价，需要在注册时明确住宿需求）",
    phone: "018678748556",
    mapUrl:
